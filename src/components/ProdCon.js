          ...
          <div key={index} className="horizontal-image-item">
            <div className="image-container">
              <div>
                ...
                <Modal isOpen={modalIsOpen[index]} onRequestClose={() => closeModal(index)} style={customStyles} contentLabel="Example Modal">
                  <h2>Hello</h2>
                  <img src={item} alt={`Image ${index + 1}`} className="resized-image" onClick={() => closeModal(index)} />
                </Modal>
              </div>
            </div>
          </div>
