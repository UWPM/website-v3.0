        ...
        <Row className="meet-team-container">
          <Col>
            ...
            <Row className="profile-row">
              ...
              />
              <TeamProfileCard
                name={Execs.Kaelen.name}
                role={Execs.Kaelen.role}
                link={Execs.Kaelen.link}
                image={Execs.Kaelen.image}
              />
              <TeamProfileCard
            ...
            <Row className="profile-row">
              <TeamProfileCard
                name={Execs.Sherya.name}
                role={Execs.Sherya.role}
                link={Execs.Sherya.link}
                image={Execs.Sherya.image}
              />
              <TeamProfileCard
