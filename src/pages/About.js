      ...
      <Container>
        ...
        <Row className="mission-vision-row" id="mission">
          ...
          <Col lg={6} className="about-us-card">
            ...
            <div className="card-body">
              <h4 className="mission-text">
              Inspire product-level thinking and explore the rationale behind what we should build 
              and why that will propel students towards successful careers in product.
              </h4>
            </div>
