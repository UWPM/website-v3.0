  ...
  return (
    <>
      ...
      <Container>
        ...
        {/* TODO: Team is becoming its own page (see doc "About us page - Events page - Team
            page"). Disabled per review — do not delete, will be moved to the new Team page. */}
        {false && (
            ...
            <Col>
              ...
              <Row>
                <p className="team-paragraph">
                  The UW Product Management Club consists of a passionate group
                  of students with a great deal of skills in marketing,
              ...
              <Row className="team-type">
                ...
                <p className="team-paragraph">
                  The Internal Team is the backbone of UW PM! They are
                  responsible for setting term goals and providing support and
                  guidance to the rest of the teams.
                </p>
              </Row>
              ...
              <Row className="team-type" id="podcast">
                ...
                <p className="team-paragraph">
                  The Podcast Team produces our weekly episodes and creative
                  audio content around product management!
                </p>
              </Row>
              <Row className="profile-row">
                <TeamProfileCard
              ...
              <Row className="team-type">
                ...
                <p className="team-paragraph">
                  The Events Team plans and executes all our exciting
                  initiatives for the UW PM community!
                </p>
              </Row>
              <Row className="profile-row">
                <TeamProfileCard
              ...
              <Row className="team-type">
                ...
                <p className="team-paragraph">
                  The Content Team writes and curates newsletters, blog posts,
                  and social features that inspire the UW PM community.
                </p>
              </Row>
              <Row className="profile-row">
                <TeamProfileCard
